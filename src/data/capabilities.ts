// src/data/capabilities.ts — 100% Pure Client Copy for Services & Capabilities
...
export const sectorDataList: Record<'government' | 'nonprofits' | 'philanthropy', SectorData> = {
  government: {
    ...
    ctaTitle: 'Explore how these capabilities apply in public systems',
    ctaDesc: 'See applied AI case studies across public services, citizen interfaces, and administrative workflows.',
  ...
  nonprofits: {
    ...
    ctaLabel: 'See it in practice',
    ctaTitle: 'Explore how these capabilities apply in development programmes',
    ctaDesc: 'See applied AI case studies across programme evidence, knowledge platforms, and responsible adoption.',
  ...
  philanthropy: {
    ...
    ctaLabel: 'See it in practice',
    ctaTitle: 'Explore how these capabilities apply across grant portfolios',
    ctaDesc: 'See applied AI case studies across evidence synthesis, shared infrastructure, and independent evaluation.',
    ctaHref: '/ai-in-action/monitoring-evaluation-responsible-ai',
    ctaButtonText: 'See it in practice'
  }
};
